...
routes = {
    ...
    "movimento_route": "/movimento", "movimento_controller": Movimento.as_view("delete"),
...
app.add_url_rule(routes["movimento_route"], view_func=routes["movimento_controller"])
...
app.add_url_rule(routes["entradasaida_route"], view_func=routes["entradasaida_controller"])
